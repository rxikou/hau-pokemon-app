...
if ($id === null || $name === '' || $type === '' || $lat === null || $lng === null || $radius === null) {
...
// s s d d d s i
$stmt->bind_param('ssdddsi', $name, $type, $lat, $lng, $radius, $pictureUrl, $id);
...
echo json_encode([
    "success" => true,
    "message" => $affected > 0 ? "Monster updated." : "No changes applied.",
